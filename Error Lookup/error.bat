@echo off
title Error Lookup
echo Welcome to the Error Lookup Tool
set 1=%1
if not defined 1 goto notdefined
if %1==-s slui 0x2a %2 && goto end
if %1==-c certutil -error %2 && goto end
if not %1==-e goto notdefined
...
:notdefined
echo You did not Enter the Right Arguments or any Arguments at All.
echo The Arguments are: -s for Slui, -c for Certutil -e for Err
pause
