...
if errorlevel 7 set option=7
IF %option%==1 shutdown /l
IF %option%==5 shutdown /a 
IF %option%==6 cmd /c ""F:\Required for Boot\RestartExplorer.bat""
IF %option%==7 goto qna
